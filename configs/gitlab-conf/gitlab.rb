...
external_url "https://gitlab.site.de"
...
# nginx['ssl_client_certificate'] = "/etc/gitlab/ssl/ca.crt" # Most root CA's are included by default
 nginx['ssl_certificate'] = "/etc/letsencrypt/live/gitlab.site.de/cert.pem"
 nginx['ssl_certificate_key'] = "/etc/letsencrypt/live/gitlab.site.de/privkey.pem"
